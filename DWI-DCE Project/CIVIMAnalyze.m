...
classdef CIVIMAnalyze < handle
    ...
    methods 
        ...
        function this = CIVIMAnalyze(adcMatrix, iStruct, combinationName, numOfADC, ...
                bValueArray, yMatrix)
        % constructor
        ...
        function copyclick(this, ~, ~, varargin)
            ...
            for i = 1:num
                ...
                for j = 1:this.comNumber
                    ...
                    this.texts{indexNum+num} = showvalues(i,RoiInfo, xx+20, yy, this.adcAxes(j));                   
                end
                RoiInfo = adcanalysis(this.image, bw);
                this.texts{i} = showvalues(i,RoiInfo, xx+20, yy, this.imax);
            end
